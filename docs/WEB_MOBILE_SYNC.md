...
| Quran audio range player | Quran reader | Dashboard Quran reader | Mobile reader now supports qari selection, start/end surah range, end ayah limit, repeat, and playback speed. Per-ayah play still works from the ayah action sheet/detail sheet. |
