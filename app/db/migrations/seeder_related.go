	...
	data := []colItem{
		{
			...
			items: []model.TahlilItem{
				{SortOrder: 1, Label: "Pembukaan", Arabic: "بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ", Transliteration: "Bismillaahir rahmaanir rahiim", Translation: "Dengan nama Allah Yang Maha Pengasih lagi Maha Penyayang", Repeat: 1},
				{SortOrder: 2, Label: "Al-Fatihah (untuk Nabi ﷺ)", Arabic: "الْحَمْدُ لِلَّهِ رَبِّ الْعَالَمِينَ ﴿١﴾ الرَّحْمَنِ الرَّحِيمِ ﴿٢﴾ مَالِكِ يَوْمِ الدِّينِ ﴿٣﴾ إِيَّاكَ نَعْبُدُ وَإِيَّاكَ نَسْتَعِينُ ﴿٤﴾ اهْدِنَا الصِّرَاطَ الْمُسْتَقِيمَ ﴿٥﴾ صِرَاطَ الَّذِينَ أَنْعَمْتَ عَلَيْهِمْ غَيْرِ الْمَغْضُوبِ عَلَيْهِمْ وَلَا الضَّالِّينَ ﴿٦﴾", Transliteration: "Alhamdulillaahi rabbil 'aalamiin. Ar-rahmaanir rahiim. Maaliki yawmid diin. Iyyaaka na'budu wa iyyaaka nasta'iin. Ihdinash shiraathal mustaqiim. Shiraathal ladziina an'amta 'alayhim ghayril maghdhuubi 'alayhim wa lad dhaalliin.", Translation: "Segala puji bagi Allah, Tuhan semesta alam. Yang Maha Pengasih lagi Maha Penyayang. Raja di Hari Pembalasan. Hanya kepada-Mu kami menyembah dan hanya kepada-Mu kami memohon pertolongan. Tunjukilah kami jalan yang lurus. Yaitu jalannya orang-orang yang Engkau beri nikmat, bukan jalan yang dimurkai dan bukan pula jalan yang sesat.", Repeat: 1},
				{SortOrder: 3, Label: "Al-Ikhlas", Arabic: "قُلْ هُوَ اللَّهُ أَحَدٌ ﴿١﴾ اللَّهُ الصَّمَدُ ﴿٢﴾ لَمْ يَلِدْ وَلَمْ يُولَدْ ﴿٣﴾ وَلَمْ يَكُن لَّهُ كُفُوًا أَحَدٌ ﴿٤﴾", Transliteration: "Qul huwallahu ahad. Allahush shamad. Lam yalid wa lam yuulad. Wa lam yakul lahu kufuwan ahad.", Translation: "Katakanlah: Dialah Allah Yang Maha Esa. Allah adalah tempat bergantung. Dia tidak beranak dan tidak diperanakkan. Dan tidak ada yang setara dengan Dia.", Repeat: 3},
				{SortOrder: 4, Label: "Al-Falaq", Arabic: "قُلْ أَعُوذُ بِرَبِّ الْفَلَقِ ﴿١﴾ مِن شَرِّ مَا خَلَقَ ﴿٢﴾ وَمِن شَرِّ غَاسِقٍ إِذَا وَقَبَ ﴿٣﴾ وَمِن شَرِّ النَّفَّاثَاتِ فِي الْعُقَدِ ﴿٤﴾ وَمِن شَرِّ حَاسِدٍ إِذَا حَسَدَ ﴿٥﴾", Transliteration: "Qul a'uudzu birabbil falaq. Min syarri maa khalaq. Wa min syarri ghaasiqin idzaa waqab. Wa min syarrin naffaatsaati fil 'uqad. Wa min syarri haasidin idzaa hasad.", Translation: "Katakanlah: Aku berlindung kepada Tuhan yang menguasai subuh. Dari kejahatan makhluk-Nya. Dari kejahatan malam apabila telah gelap gulita. Dari kejahatan wanita-wanita tukang sihir yang menghembus buhul. Dan dari kejahatan orang yang dengki apabila ia dengki.", Repeat: 1},
				{SortOrder: 5, Label: "An-Nas", Arabic: "قُلْ أَعُوذُ بِرَبِّ النَّاسِ ﴿١﴾ مَلِكِ النَّاسِ ﴿٢﴾ إِلَٰهِ النَّاسِ ﴿٣﴾ مِن شَرِّ الْوَسْوَاسِ الْخَنَّاسِ ﴿٤﴾ الَّذِي يُوَسْوِسُ فِي صُدُورِ النَّاسِ ﴿٥﴾ مِنَ الْجِنَّةِ وَالنَّاسِ ﴿٦﴾", Transliteration: "Qul a'uudzu birabbin naas. Malikin naas. Ilaahin naas. Min syarril waswaasil khannaas. Alladzii yuwaswisu fii shuduurin naas. Minal jinnati wan naas.", Translation: "Katakanlah: Aku berlindung kepada Tuhan manusia. Raja manusia. Sembahan manusia. Dari kejahatan bisikan setan yang biasa bersembunyi. Yang membisikkan ke dalam dada manusia. Dari (golongan) jin dan manusia.", Repeat: 1},
