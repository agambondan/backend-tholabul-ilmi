        ...
        },
        {
            ...
            endpoints: [
                ...
                { method: 'GET', path: '/api/v1/hadiths', desc: 'Daftar hadith' },
	                ...
	                { method: 'GET', path: '/api/v1/hadiths/book/:slug/number/:number', desc: 'Detail hadith berdasarkan kitab dan nomor' },
        ...
        },
        {
            ...
            endpoints: [
                ...
                { method: 'GET', path: '/api/v1/hadiths', desc: 'List hadiths' },
	                ...
	                { method: 'GET', path: '/api/v1/hadiths/book/:slug/number/:number', desc: 'Hadith details by book and number' },
