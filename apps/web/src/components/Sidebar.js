...
const Sidebar = ({ onClose }) => {
    ...
    const GROUPS = [
        ...
        },
        {
            ...
            auth: true,
            links: [
                { labelKey: 'link.sholat_tracker', href: '/sholat-tracker', icon: <MdMosque /> },
                { labelKey: 'link.recitation', href: '/tilawah', icon: <BsJournalCheck /> },
                { labelKey: 'link.memorization', href: '/hafalan', icon: <BsBook /> },
                { labelKey: 'link.review', href: '/muroja-ah', icon: <MdRefresh /> },
                { labelKey: 'link.deeds', href: '/amalan', icon: <MdFormatListBulleted /> },
                { labelKey: 'link.muhasabah', href: '/muhasabah', icon: <MdSelfImprovement /> },
                { labelKey: 'link.goals', href: '/goals', icon: <MdFlag /> },
            ],
        },
        {
        ...
        },
        {
            ...
            links: [
                ...
                { labelKey: 'link.bookmarks', href: '/bookmarks', icon: <BsBookmark /> },
                { labelKey: 'link.notes', href: '/notes', icon: <BsStickyFill /> },
                { labelKey: 'link.statistics', href: '/stats', icon: <BsBarChart /> },
                { labelKey: 'link.notifications', href: '/notifications', icon: <BsBell /> },
                { labelKey: 'link.profile', href: '/profile', icon: <BsPerson /> },
            ],
        },
    ];
